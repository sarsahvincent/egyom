...
import ProfileDetailsNavigationTab from "./ProfileDetailsNavigationTab";
...
const serviceData: details[] = [
  {
    ...
    skills: ["illustrator", "Node", "Illustrator"],

    biography:
      "Lorem ipsum dolor sit amet consectetur adipisicing elit. Cumque aliquam aliquid eveniet, fugiat repellat, illum pariatur nulla qui ea dolorum, blanditiis ipsam molestiae minus sint reiciendis mollitia error voluptate expedita.",
  },
];
interface Skills {
  skills: string[];
            ...
            <CardContent>
              ...
              <div>
                ...
                <p>
                  ...
                  Praesentium vel eveniet labore, accusamus culpa eum
                  dignissimos non repellat. Obcaecati tenetur tempora ipsa
                  blanditiis distinctio illum quas, nesciunt voluptatem alias
                  expedita.
                </p>
              </div>
              <hr className={styles.hr} />
